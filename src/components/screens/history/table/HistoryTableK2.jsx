...
const HistoryTableK2 = () => {
  ...
  const headers = [
    { label: "Результат (X)", key: "resultValue" },
    { label: "Относительная погрешность ([δ], %)", key: "value3" },
    { label: "Результат измерений X", key: "value2" },
    { label: "Разрядность", key: "value1" },
    { label: "Неопределённость по типу В(Ubδ)", key: "uncertaintyBType" },
